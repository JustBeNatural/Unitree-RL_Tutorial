...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlOnPolicyRunnerCfg):
    ...
    # Compatibility patch for Isaac Lab config + rsl-rl-lib==3.0.1.
    # Newer Isaac Lab may add algorithm fields that older RSL-RL PPO does not accept.
    if "algorithm" in train_cfg:
        train_cfg["algorithm"].pop("optimizer", None)
        train_cfg["algorithm"].pop("share_cnn_encoders", None)
