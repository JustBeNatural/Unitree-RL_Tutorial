# Unitree-RL_Tutorial
这个仓库记录我学习 Unitree 机器人强化学习仿真的过程，主要围绕 Unitree RL Lab、Isaac Lab、RSL-RL 和 PPO 算法展开。
目前内容更偏向初学者入门：我会把自己在学习中遇到的概念、训练流程、实验截图和算法理解整理出来，方便后续复盘，也希望能给刚开始接触机器人强化学习的同学一个参考。
下面是宇树官方放出的README教程，跟着走安装好环境复现就可以了。代码里另外三个md文件是我写的学习日记。
